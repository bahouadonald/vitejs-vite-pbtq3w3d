...
Rejoins Doniel Zik et fais décoller ta carrière partout en Afrique. Ton 1er contenu est 100% OFFERT 🎁

Sur Doniel Zik, chaque fan te rapporte :
✅ Écoutes en streaming & vues de tes clips
✅ Téléchargements payants de ta musique et de tes vidéos
✅ Cadeaux Oscart envoyés par tes fans
✅ Pochettes QR : tes fans achètent ta pochette, la scannent et écoutent (ils peuvent même télécharger)
✅ Sorties officielles : tes fans réservent ta musique en payant à l'avance, avant la sortie

Ton talent + tes fans = tes revenus. Et tu deviens connu. 🚀

👉 Inscris-toi maintenant, c'est gratuit : ${lien}`;
  ...
  return (
    <div style={S.bg}>
      ...
      <div style={{ maxWidth: 960, margin: '0 auto', padding: 24 }}>
        ...
        {/* LIEN D'INSCRIPTION ARTISTE (ADMIN) */}
